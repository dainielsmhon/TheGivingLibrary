...
namespace BLL
{
    public class Book
    {
        ...
        public int AvailableQuantity { get; set; }//גמות זמינה
        public int TotalQuantity { get; set; } // כמות כוללת של ספרים
        public int SupplierId { get; set; }
        public string ImageUrl { get; set; } = "assets/images/library-bg.jpg";
